...
export const H1 = styled.h1<{ color?: string }>`
    ...
    margin: 0;
    width: fit-content;
    font-weight: ${({ theme }) => theme.typography && theme.typography.weight[600]};
    line-height: ${({ theme }) => theme.typography && theme.typography.lineHeight.l2}px;
`;

export const H2 = styled.h2<{ color?: string }>`
    color: ${({ theme }) => theme.color && theme.color.gray[900]};
...
export const H4_ENG = styled.h4<{ color?: string }>`
    ...
    margin: 0;
    font-weight: ${({ theme }) => theme.typography && theme.typography.weight[600]};
    line-height: ${({ theme }) => theme.typography && theme.typography.lineHeight.m2}px;
    width: fit-content;
`;
...
export const H4_KR = styled.h4<{ color?: string }>`
    ...
    font-style: normal;
    margin: 0;
    font-weight: ${({ theme }) => theme.typography && theme.typography.weight[500]};
    line-height: ${({ theme }) => theme.typography && theme.typography.lineHeight.m2}px;
    width: fit-content;
`;
...
export const BodyM = styled.p<{ color?: string }>`
    ...
    font-style: normal;
    margin: 0;
    font-weight: ${({ theme }) => theme.typography && theme.typography.weight[400]};
    line-height: ${({ theme }) => theme.typography && theme.typography.lineHeight.m1}px;
    width: fit-content;
`;
...
export const BodyS = styled.p<{ color?: string }>`
    ...
    margin: 0;
    font-weight: ${({ theme }) => theme.typography && theme.typography.weight[400]};
    line-height: ${({ theme }) => theme.typography && theme.typography.lineHeight.s3}px;
    width: fit-content;
`;
...
export const CaptionM = styled.p<{ color?: string }>`
    ...
    margin: 0;
    font-weight: ${({ theme }) => theme.typography && theme.typography.weight[400]};
    line-height: ${({ theme }) => theme.typography && theme.typography.lineHeight.s2}px;
    width: fit-content;
`;
...
export const CaptionS = styled.p<{ color?: string }>`
    ...
    margin: 0;
    font-weight: ${({ theme }) => theme.typography && theme.typography.weight[400]};
    line-height: ${({ theme }) => theme.typography && theme.typography.lineHeight.s1}px;
    width: fit-content;
`;
